...
def plot_events(x='time'):
    scale = 1
    call_duration = 2
    distance_near_side = 45
    label_near_side = 'sparse'
    distance_far_side = 75
    label_far_side = 'dense'
    ...
    pyplot.text(start_of_emission, min_y, 'Emission')
...
title = '15 cm of midline towards sparse side'

data = pandas.read_csv('warnecke2.csv')
